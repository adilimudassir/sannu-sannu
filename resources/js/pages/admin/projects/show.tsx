...
import { formatCurrency, formatDate, formatPercentage, formatTimeRemaining } from '@/lib/formatters';
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">System Admin - Project details and management</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {canActivate && project.status === 'draft' && (
                            <Button onClick={() => handleStatusChange('activate')} className="bg-green-600 hover:bg-green-700">
                            ...
                            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Are you sure you want to delete "{project.name}"? This action cannot be undone. All project data,
                                            products, and associated records will be permanently removed.
                                        </DialogDescription>
                                    </DialogHeader>
                                    <DialogFooter>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-2 text-sm">
                                            ...
                                            <span className="font-semibold text-primary">{formatCurrency(project.total_amount)}</span>
                                        </div>
                                ...
                                {isSystemAdmin && project.tenant && (
                                    <>
                                        <Separator />
                                        <div>
                                            <h4 className="mb-2 font-medium">Tenant Information</h4>
                                            <div className="flex items-center gap-2 text-sm">
                        ...
                        {project.products && project.products.length > 0 && (
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Items and services included in this project</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm">
                                            ...
                                            <span className="font-medium">{formatPercentage(stats.completion_percentage)}</span>
                                        </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="font-semibold">{formatCurrency(stats.average_contribution)}</span>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="font-semibold">{formatTimeRemaining(project.end_date)}</span>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="text-xs text-muted-foreground">{formatDate(project.start_date)}</div>
                                        </div>
                                    </div>
                                    ...
                                    {project.registration_deadline && (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="text-xs text-muted-foreground">{formatDate(project.registration_deadline)}</div>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div
                                            className={`h-2 w-2 rounded-full ${new Date(project.end_date) <= new Date() ? 'bg-primary' : 'bg-muted'}`}
                                        />
                                        <div className="flex-1">
